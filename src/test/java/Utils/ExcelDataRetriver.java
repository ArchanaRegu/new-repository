...
public String getExceldataFromTestdat1(int RowNum,int colNum) throws IOException {
	String excelpath=System.getProperty("user.dir")+"/src/test/resources/excel/Testdata1.xlsx";
	XSSFWorkbook workbook=new XSSFWorkbook(excelpath);
	XSSFSheet sheet=workbook.getSheet("Sheet1");
	String validInvalid=sheet.getRow(RowNum).getCell(colNum).getStringCellValue();
	return validInvalid;
